 ...
 */
package com.clsaa.tiad.idea.action.base;

import com.clsaa.tiad.idea.dialog.TiadCreateFromTemplateDialog;
...
public abstract class TiadCreateFromTemplateActionBase extends AnAction {
    public TiadCreateFromTemplateActionBase(final String title, final String description, final Icon icon) {
    ...
    public final void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (selectedTemplate != null) {
            ...
            if (action != null) {
                ...
                TiadCreateFromTemplateDialog dialog = new TiadCreateFromTemplateDialog(project, dir, selectedTemplate, defaults, properties);
    ...
    protected void elementCreated(TiadCreateFromTemplateDialog dialog, PsiElement createdElement) {
    }
