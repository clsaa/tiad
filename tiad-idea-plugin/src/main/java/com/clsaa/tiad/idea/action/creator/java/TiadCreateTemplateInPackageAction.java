...
import com.clsaa.tiad.idea.action.creator.TiadCreateFromTemplateAction;
 ...
 * @author peter
 */
public abstract class TiadCreateTemplateInPackageAction<T extends PsiElement> extends TiadCreateFromTemplateAction<T> {
    private final Set<? extends JpsModuleSourceRootType<?>> mySourceRootTypes;

    protected TiadCreateTemplateInPackageAction(String text, String description, Icon icon,
    ...
    @Override
    @Nullable
    protected T createFile(String name, String templateName, PsiDirectory dir, Map<String, String> properties) {
        return checkOrCreate(name, dir, templateName, properties);
    }
    ...
    @Nullable
    private T checkOrCreate(String newName, PsiDirectory directory, String templateName, Map<String, String> properties =) throws IncorrectOperationException {
