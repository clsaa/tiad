...
public abstract class TiadJavaCreateTemplateInPackageAction<T extends PsiElement> extends TiadCreateTemplateInPackageAction<T> {

    protected TiadJavaCreateTemplateInPackageAction(String text, String description, Icon icon, boolean inSourceOnly) {
        super(text, description, icon, inSourceOnly ? JavaModuleSourceRootTypes.SOURCES : null);
    }

    protected TiadJavaCreateTemplateInPackageAction(String text,
                                                    String description,
                                                    Icon icon,
