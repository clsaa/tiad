...
package com.clsaa.tiad.idea.dialog;

import com.clsaa.tiad.idea.util.TiadFileTemplateUtil;
...
public class TiadCreateFromTemplateDialog extends DialogWrapper {
    ...
    public TiadCreateFromTemplateDialog(@NotNull Project project,
        ...
        TiadFileTemplateUtil.fillDefaultProperties(myDefaultProperties, directory);
        boolean mustEnterName = TiadFileTemplateUtil.findHandler(template).isNameRequired();
    ...
    private void doCreate(@Nullable String fileName) {
        try {
            ...
            myCreatedElement = TiadFileTemplateUtil.createFromTemplate(myTemplate, newName, properties, directory);
        } catch (Exception e) {
            showErrorDialog(e);
        }
    }
    ...
    private String getErrorMessage() {
        return TiadFileTemplateUtil.findHandler(myTemplate).getErrorMessage();
    }
