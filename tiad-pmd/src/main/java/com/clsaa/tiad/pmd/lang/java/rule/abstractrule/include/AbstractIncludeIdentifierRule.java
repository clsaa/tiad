 ...
 */
@Slf4j
public abstract class AbstractIncludeIdentifierRule extends AbstractAnnotatableRule {
    @Override
    public Object visit(ASTAnnotation node, Object data) {
        ...
        final List<ASTAnnotation> annotations = ASTUtils.findDescendantsAnnotations(Objects.requireNonNull(classOrInterfaceDeclaration), Identifier.class);
