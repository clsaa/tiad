...
public class AggregateShouldInABounderContextRuleTest extends AbstractAggregatePmdTest {
    @Override
    public String getCheckFilePath() {
        return testfilePath + "package-info" + ".java";
    }
    ...
    public RuleContext getRuleContext() {
        ...
        final Location location = Location.builder().packageName(com.clsaa.tiad.pmd.lang.java.rule.entity.testfile.tmp.Aggregate.class.getPackage().getName()).build();
