...
import com.clsaa.tiad.pmd.lang.java.rule.entity.testfile.EntityMustHaveOneIdentifierRuleTestTarget;
...
public class EntityMustHaveOneIdentifierRuleTest extends AbstractEntityPmdTest {
    @Override
    public String getCheckFilePath() {
        return testfilePath + EntityMustHaveOneIdentifierRuleTestTarget.class.getSimpleName() + ".java";
    }
