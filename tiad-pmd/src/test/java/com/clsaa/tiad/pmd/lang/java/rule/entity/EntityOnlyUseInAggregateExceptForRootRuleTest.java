...
import com.clsaa.tiad.pmd.lang.java.rule.entity.testfile.EntityOnlyUseInAggregateExceptForRootRuleTestTarget;
...
public class EntityOnlyUseInAggregateExceptForRootRuleTest extends AbstractEntityPmdTest {
    @Override
    public String getCheckFilePath() {
        return testfilePath + EntityOnlyUseInAggregateExceptForRootRuleTestTarget.class.getSimpleName() + ".java";
    }
    ...
    public RuleContext getRuleContext() {
        ...
        final Location location = Location.builder().fullClassName(MyEntity.class.getName()).build();
