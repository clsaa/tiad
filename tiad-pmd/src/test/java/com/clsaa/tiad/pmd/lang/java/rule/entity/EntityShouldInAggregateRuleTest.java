...
public class EntityShouldInAggregateRuleTest extends AbstractEntityPmdTest {
    @Override
    ...
    public RuleContext getRuleContext() {
        ...
        final Location location = Location.builder().packageName(this.getClass().getPackage().getName()).build();
