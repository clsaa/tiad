...
import com.clsaa.tiad.pmd.lang.java.rule.valueobject.testfile.ValueObjectNonIdentifierRuleTestTarget;
...
public class ValueObjectNonIdentifierRuleTest extends AbstractValueObjectPmdTest {
    @Override
    public String getCheckFilePath() {
        return testfilePath + ValueObjectNonIdentifierRuleTestTarget.class.getSimpleName() + ".java";
    }
